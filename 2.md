...
| 間 | あいだ、 ま、 あい | カン、 ケン | (Both Spatial and Temporal) Space, Extent/Scope, Relation/Relationship |
| 外 | そと、 ほか、 はず.す、 はず.れる、 と- | ガイ、 ゲ | Outside, Foreign, Other/Rest |
| 計 | はか.る、 はか.らう | ケイ | To measure/Weigh, To infer, Plan, Meter, Measuring device |
| 手 | て、 て-、 -て、 た- | シュ、 ズ | Hand, Handle/Grip, Paw, Handicraft, Skill/Talent, Way of doing something/Means, One who does something, (Board Games like Shogi, Go, etc.) Move |
